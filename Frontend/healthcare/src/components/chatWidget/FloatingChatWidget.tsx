...
import { Maximize2, MessageCirclePlus, Send, Stethoscope, X, Loader2 } from "lucide-react";
...
const POPUP_GAP = 14;
const DEFAULT_POPUP_SIZE = { width: 390, height: 560 };
...
const getPopupPosition = (bubblePos: Point, popupSize: Size): Point => {
  ...
  return {
    ...
    y: clamp(preferredTop, VIEWPORT_PADDING, window.innerHeight - popupSize.height - VIEWPORT_PADDING),
  };
};
...
const FloatingChatWidget: React.FC = () => {
  ...
  return (
    <div className="floating-chat-widget" aria-live="polite">
      {isOpen && (
        <section
          className="floating-chat-widget__popup"
          style={{
            left: popupPos.x,
            top: popupPos.y,
        ...
        >
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={
                    message.role === "assistant"
                      ? { __html: formatChatAnswer(message.content) }
                      : undefined
                  }
                >
          ...
          <button
            ...
            aria-label="Kéo để đổi kích thước popup chat"
          />
        </section>
      )}
      ...
      <button
        ...
        aria-label={isOpen ? "Đóng chatbot tư vấn nhanh" : "Mở chatbot tư vấn nhanh"}
