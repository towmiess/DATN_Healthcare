...
class AiInsightRequestSerializer(serializers.Serializer):
    intent = serializers.ChoiceField(choices=["advice", "improve_metrics"], default="advice")
    period_type = serializers.ChoiceField(choices=["weekly", "monthly"], default="monthly")
