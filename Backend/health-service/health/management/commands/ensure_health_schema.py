...
CREATE TABLE IF NOT EXISTS ai_insights (
    id bigserial PRIMARY KEY,
    user_id bigint NOT NULL REFERENCES users(id),
    risk_prediction_id bigint REFERENCES risk_predictions(id),
    assessment_id bigint REFERENCES health_assessments(id),
...
CREATE TABLE IF NOT EXISTS health_goals (
    ...
    smoking_status varchar(30) DEFAULT 'UNKNOWN',
    alcohol_status varchar(30) DEFAULT 'UNKNOWN',
    stroke_tia boolean,
    retinopathy boolean,
    neuropathy_foot boolean,
    created_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    UNIQUE (user_id)
